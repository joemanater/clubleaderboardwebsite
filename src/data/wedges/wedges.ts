...
export const wedges: Wedge[] = [
  // ─── 1. Titleist Vokey SM11 ──────────────────────────────────────────────────
  {
    ...
    msrp: 199,
    currency: 'USD',
    imageUrl: '/images/wedges/vokey-sm11.webp',
  ...
  // ─── 2. TaylorMade Milled Grind 5 (MG5) ─────────────────────────────────────
  {
    ...
    msrp: 199,
    currency: 'USD',
    imageUrl: '/images/wedges/taylormade-mg5.webp',
  ...
  // ─── 3. Callaway CB 12 ──────────────────────────────────────────────────────
  {
    ...
    msrp: 179,
    currency: 'USD',
    imageUrl: '/images/wedges/callaway-cb12.webp',
  ...
  // ─── 4. PING s259 ───────────────────────────────────────────────────────────
  {
    ...
    msrp: 217,
    currency: 'USD',
    imageUrl: '/images/wedges/ping-s259.webp',
  ...
  // ─── 5. Mizuno Pro T-1 ──────────────────────────────────────────────────────
  {
    ...
    msrp: 179,
    currency: 'USD',
    imageUrl: '/images/wedges/mizuno-pro-t1.webp',
  ...
  // ─── 6. Cleveland RTX 6 ZipCore ──────────────────────────────────────────────
  {
    ...
    msrp: 139,
    currency: 'USD',
    imageUrl: '/images/wedges/cleveland-rtx-6-zipcore.webp',
  ...
  // ─── 7. Cobra King Wedge (2025) ──────────────────────────────────────────────
  {
    ...
    msrp: 170,
    currency: 'USD',
    imageUrl: '/images/wedges/cobra-king-wedge-2025.webp',
  ...
  // ─── 8. PXG Sugar Daddy III ──────────────────────────────────────────────────
  {
    ...
    msrp: 299,
    currency: 'USD',
    imageUrl: '/images/wedges/pxg-sugar-daddy-iii.webp',
  ...
  // ─── 9. Titleist Vokey WedgeWorks (Limited) ──────────────────────────────────
  {
    ...
    msrp: 275,
    currency: 'USD',
    imageUrl: '/images/wedges/vokey-wedgeworks.webp',
  ...
  // ─── 10. Callaway Opus Platinum ──────────────────────────────────────────────
  {
    ...
    msrp: 229,
    currency: 'USD',
    imageUrl: '/images/wedges/callaway-opus-platinum.webp',
  ...
  // ─── 11. Wilson Staff Model ZM ───────────────────────────────────────────────
  {
    ...
    msrp: 150,
    currency: 'USD',
    imageUrl: '/images/wedges/wilson-staff-model-zm.webp',
  ...
  // ─── 12. Mizuno Pro T-3 ──────────────────────────────────────────────────────
  {
    ...
    msrp: 179,
    currency: 'USD',
    imageUrl: '/images/wedges/mizuno-pro-t3.webp',
  ...
  // ─── 13. Srixon ZX7 Mk II Wedge ─────────────────────────────────────────────
  {
    ...
    msrp: 185,
    currency: 'USD',
    imageUrl: '/images/wedges/srixon-zx7-mkii-wedge.webp',
  ...
  // ─── 14. Tour Edge TGS ──────────────────────────────────────────────────────
  {
    ...
    msrp: 59,
    currency: 'USD',
    imageUrl: '/images/wedges/tour-edge-tgs.webp',
  ...
  // ─── 15. Cleveland CBX4 ZipCore ──────────────────────────────────────────────
  {
    ...
    msrp: 170,
    currency: 'USD',
    imageUrl: '/images/wedges/cleveland-cbx4-zipcore.webp',
